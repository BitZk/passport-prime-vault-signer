...
The production feature will be designed as an upstream KeyOS integration. The standalone Vault Signer SDK app remains a permission-minimal UX and protocol prototype and will not implement a duplicate seed store or wallet.
